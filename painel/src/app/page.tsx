...
// Kanban View for Home (Gestão de Leads)
...
import { 
  ...
  Bot, RefreshCw, Car, Thermometer,
  Sparkles, Sun, Snowflake, Phone, Trash2, GripVertical
} from "lucide-react";
      ...
      <div className="px-6 py-4 bg-background/80 backdrop-blur-sm border-b border-border sticky top-0 z-10">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">Visão geral e pipeline de vendas</p>
          </div>
